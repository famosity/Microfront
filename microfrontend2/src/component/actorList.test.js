...
test('renders MovieList component correctly', () => {
  // Renderizar el componente MovieList con datos de prueba
  const { getByText, getAllByTestId } = render(<MovieList language="English" />);
